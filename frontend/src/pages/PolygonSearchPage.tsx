...
const PolygonMap = lazy(() => import("./PolygonMap"));
...
export default function PolygonSearchPage() {
  ...
  const flyToCenter: [number, number] | null =
    selectedRegion && REGION_CENTROIDS[selectedRegion] ? REGION_CENTROIDS[selectedRegion] : null;
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, position: 'relative', minHeight: 0 }}>
        <ClientOnly fallback={<div style={{ height: '100%', width: '100%', position: 'absolute', background: '#eef2f6' }} aria-hidden="true" />}>
          {() => (
            <Suspense fallback={<div style={{ height: '100%', width: '100%', position: 'absolute', background: '#eef2f6' }} />}>
              <PolygonMap
