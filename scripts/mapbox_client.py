...
# Overridable via env for one-off bulk runs (e.g. large re-geocode cleanups).
# Keep the value below the 100k free tier with margin for the PPR sync + API.
MAPBOX_MONTHLY_LIMIT = int(os.getenv("MAPBOX_MONTHLY_LIMIT", "50000"))
